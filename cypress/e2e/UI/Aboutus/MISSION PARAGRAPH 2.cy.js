...
describe('MISSION PARAGRAPH 2', () => {
    ...
    // 9. MISSION PARAGRAPH 2
    it('TC09 - Mission paragraph #2 content', () => {
        cy.contains('p, div', 'leveraging cutting-edge technology').should('be.visible');
    });
});