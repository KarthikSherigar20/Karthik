...
describe('EB-Search name and company', () => {
    before(() => {
        cy.wrap(null).then(() => {
            login2();
        }).then(() => {
    ...
    it('Emergency-1', () => {
        cy.get('body').then(($bodyText) => {
            ...
            if (bodyText.includes('New')) {
                ...
                cy.wait(2000);
                cy.get('label[class="radioButton_label__jC0Qn"]').eq(11).scrollIntoView().click();
                cy.wait(3000);
                cy.get('label[class="radioButton_label__jC0Qn"]').eq(18).scrollIntoView().click();
                cy.wait(2000);
